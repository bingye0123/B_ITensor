...
namespace itensor {
    ...
    std::vector<int> mapping(int i){
        ...
        if (i<(NY*(NX-1))) {
            temp[0]=i%(NX-1)+(i/(NX-1))*NX;
            temp[1]=i%(NX-1)+1+(i/(NX-1))*NX;
        }
        else {
            i=i-NY*(NX-1);
            temp[0]=i%NX+(i/NX)*NX;
            temp[1]=i%NX+NX+(i/NX)*NX;
        }
        
        return temp;
    }
    
    //--------begin: randomize all the original a tensors------------------------------------------------
    void ramdomize_site_tensors(){
        //original site tensor indices: A^s_udlr
        for (int i=0; i<N; i++) {
    ...
    //--------end: randomize all the original a tensors------------------------------------------------
    //--------begin: setting up the tensor network for hamilnonian-------------------------------------------------------
    void setup_ham_tensors(int hamx, int nx, int ny){
...
//                }
                ...
                if (y==0) {
                    if (x==0) {
                        //cout<<"193~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice4((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"195~~~~~~~~"<<endl;
                    }
                    else if (x==nx-1) {
                        //cout<<"198~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice4((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind]);
                        //cout<<"200~~~~~~~~"<<endl;
                    }
                    else {
                        //cout<<"203~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice6((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"205~~~~~~~~"<<endl;
                    }
                }
                else if (y==ny-1) {
                    if (x==0) {
                        //cout<<"210~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice4((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"212~~~~~~~~"<<endl;
                    }
                    else if (x==nx-1) {
                        //cout<<"215~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice4((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], l[ind], primed(l[ind]), L[ind]);
                        //cout<<"217~~~~~~~~"<<endl;
                    }
                    else {
                        //cout<<"220~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice6((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"222~~~~~~~~"<<endl;
                    }
                }
                else {
                    if (x==0) {
                        //cout<<"227~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice6((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"229~~~~~~~~"<<endl;
                    }
                    else if (x==nx-1) {
                        //cout<<"232~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice6((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind]);
                        //cout<<"234~~~~~~~~"<<endl;
                    }
                    else {
                        //cout<<"237~~~~~~~~"<<endl;
                        W[ind+nx*ny*hamx]=group_indice8((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"239~~~~~~~~"<<endl;
                    }
                }
            }
        ...
        for (int x=0; x<nx; x++) {
            for (int y=0; y<ny; y++) {
                ...
                if (y==0) {
                    if (x==0) {
                        //cout<<"299~~~~~~~~"<<endl;
                        IW[ind]=group_indice4((Identity[ind]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"301~~~~~~~~"<<endl;
                    }
                    else if (x==nx-1) {
                        //cout<<"304~~~~~~~~"<<endl;
                        IW[ind]=group_indice4((Identity[ind]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind]);
                        //cout<<"306~~~~~~~~"<<endl;
                    }
                    else {
                        //cout<<"309~~~~~~~~"<<endl;
                        IW[ind]=group_indice6((Identity[ind]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"311~~~~~~~~"<<endl;
                    }
                }
                else if (y==ny-1) {
                    if (x==0) {
                        //cout<<"316~~~~~~~~"<<endl;
                        IW[ind]=group_indice4((Identity[ind]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"318~~~~~~~~"<<endl;
                    }
                    else if (x==nx-1) {
                        //cout<<"321~~~~~~~~"<<endl;
                        IW[ind]=group_indice4((Identity[ind]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], l[ind], primed(l[ind]), L[ind]);
                        //cout<<"323~~~~~~~~"<<endl;
                    }
                    else {
                        //cout<<"326~~~~~~~~"<<endl;
                        IW[ind]=group_indice6((Identity[ind]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"328~~~~~~~~"<<endl;
                    }
                }
                else {
...
//                        Print(R[ind]);
                        ...
                        IW[ind]=group_indice6((Identity[ind]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"335~~~~~~~~"<<endl;
                    }
                    else if (x==nx-1) {
                        //cout<<"338~~~~~~~~"<<endl;
                        IW[ind]=group_indice6((Identity[ind]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind]);
                        //cout<<"340~~~~~~~~"<<endl;
                    }
                    else {
                        //cout<<"343~~~~~~~~"<<endl;
                        IW[ind]=group_indice8((Identity[ind]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        //cout<<"345~~~~~~~~"<<endl;
                    }
                }
            }
...
//    //--------begin: setting up the tensor network for hamilnonian-------------------------------------------------------
//    void setup_ham_tensors(int hamx){
//        /*
//        for (int i=0; i<N; i++) {
//            U[i]=Index(nameint("U",i),NB*NB);
//            D[i]=Index(nameint("D",i),NB*NB);
...
namespace itensor {
    ...
    void setup_tensors(){
        ...
        //    cout<<i<<":"<<"("<<mapping(i)[0]<<","<<mapping(i)[1]<<")"<<endl;
        //}
        ...
        //---------begin: Define tensors Hi_ss'=<s|Hi|s'>------------------------------
        for (int hamx=0; hamx<terms; hamx++) {
            if (hamx<(terms/2)) {
                for (int i=0; i<N; i++) {
                    O[N*hamx+i]=ITensor(s[i],primed(s[i]));
                    if (i!=(mapping(hamx)[0]) && i!=(mapping(hamx)[1])) {
                ...
                int hamxtemp=hamx-terms/2;
                for (int i=0; i<N; i++) {
                    O[N*hamx+i]=ITensor(s[i],primed(s[i]));
                    if (i!=(mapping(hamxtemp)[0]) && i!=(mapping(hamxtemp)[1])) {
                        for (int k=1; k<=NS; k++) {
                            O[N*hamx+i](s[i](k),primed(s[i])(k))=1;
                        }
                    }
                }
                O[N*hamx+mapping(hamxtemp)[0]](s[mapping(hamxtemp)[0]](1), primed(s[mapping(hamxtemp)[0]])(2))=1;
                O[N*hamx+mapping(hamxtemp)[0]](s[mapping(hamxtemp)[0]](2), primed(s[mapping(hamxtemp)[0]])(3))=1;
                O[N*hamx+mapping(hamxtemp)[1]](s[mapping(hamxtemp)[1]](2), primed(s[mapping(hamxtemp)[1]])(1))=1;
                O[N*hamx+mapping(hamxtemp)[1]](s[mapping(hamxtemp)[1]](3), primed(s[mapping(hamxtemp)[1]])(2))=1;
            }
        }
        //---------end: Define tensors O_ss'=<s|O|s'>--------------------------------
        //start: need to be comment out!!!
        for (int hamx=0; hamx<terms; hamx++) {
            if (hamx<(terms/2)) {
                cout<<hamx<<":"<<"("<<mapping(hamx)[0]<<","<<mapping(hamx)[1]<<")"<<endl;
                for (int i=0; i<N; i++) {
                    cout<<i;
                    PrintDat(O[N*hamx+i]);
                }
                ...
                int hamxtemp=hamx-terms/2;
                cout<<hamxtemp<<":"<<"("<<mapping(hamxtemp)[0]<<","<<mapping(hamxtemp)[1]<<")"<<endl;
                for (int i=0; i<N; i++) {
                    cout<<i;
                    PrintDat(O[N*hamx+i]);
                }
        ...
        //start: need to be comment out!!!
        //---------begin: Define tensors O_ss'=<s|O|s'> test------------------------------
        for (int i=0; i<N; i++) {
        ...
        //---------end: Define tensors O_ss'=<s|O|s'> test--------------------------------
        //end: need to be comment out!!!
        ...
        for (int hamx=0; hamx<terms; hamx++) {
            for (int x=0; x<NX; x++) {
                for (int y=0; y<NY; y++) {
                    ...
                    if (y==0) {
                        if (x==0) {
                            A[x+NX*hamx]=group_indice4((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], r[ind], primed(r[ind]), R[ind]);
                        }
                        else if (x==NX-1) {
                            A[x+NX*hamx]=group_indice4((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind]);
                        }
                        else {
                            A[x+NX*hamx]=group_indice6((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        }
                    }
                    else if (y==NY-1) {
                        if (x==0) {
                            B[x+NX*hamx]=group_indice4((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], r[ind], primed(r[ind]), R[ind]);
                        }
                        else if (x==NX-1) {
                            B[x+NX*hamx]=group_indice4((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], l[ind], primed(l[ind]), L[ind]);
                        }
                        else {
                            B[x+NX*hamx]=group_indice6((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        }
                    }
                    else {
                        if (x==0) {
                            W[nind+NX*(NY-2)*hamx]=group_indice6((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], r[ind], primed(r[ind]), R[ind]);
                        }
                        else if (x==NX-1) {
                            W[nind+NX*(NY-2)*hamx]=group_indice6((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind]);
                        }
                        else {
                            W[nind+NX*(NY-2)*hamx]=group_indice8((O[ind+N*hamx]*a[ind]*dag(prime(a[ind]))), u[ind], primed(u[ind]), U[ind], d[ind], primed(d[ind]), D[ind], l[ind], primed(l[ind]), L[ind], r[ind], primed(r[ind]), R[ind]);
                        }
                    }
                }
            }
