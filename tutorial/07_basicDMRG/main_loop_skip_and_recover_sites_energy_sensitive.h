...
//                            Print(eigenvalues);
//                            BF=shift_matrix(BF,2*IF.indices()[0].m());
//                            EigenValues(BF, eigenvalues, eigenvectors);
//                            Print(eigenvalues);
//                            Matrix BFF=BF;
//                            CholeskyFactorization(BFF);
                            skip_flag=1;
                            if (printflag==0) {
                                cout<<"Positive definiteness: skip updating current site!!!"<<endl;
                                cout<<"--------------------------------------"<<endl;
                                cout<<endl;
                            }
                        }
                            ...
                            if (eigenvalues(min_index)>energy) {
                                skip_flag=1;
                                if (printflag==0) {
                                    cout<<"Energy sensitive: skip updating current site!!!"<<endl;
                                    cout<<"--------------------------------------"<<endl;
                                    cout<<endl;
                                }
                            }
