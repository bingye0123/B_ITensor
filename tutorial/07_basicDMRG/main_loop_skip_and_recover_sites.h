                ...
                for (int X=0; X<nx; X++) {  //int X=0; X<nx; X++
                    ...
                    if (rank==root) {
                        ...
                        if (_switch==1) {
                            ...
                            if (cholesky_flag==0) {
                                ...
                                //~~~~~~~~~~~cout<<"Skip optimization of site ("<<X<<", "<<Y<<") !!!"<<endl;
                                cout<<"--------------------------------------"<<endl;
                                cout<<endl;
                            }
                        }
                    ...
                    if (rank==root) {
                        for (int ranki=0; ranki<size; ranki++) {
                            if (ranki!=root) {
                                MPI_Send(&skip_flag, 1, MPI_INT, ranki, 0, communicator);
                            }
                        }
                        MPI_Barrier(communicator);
                    }
                    ...
                    if (rank==root) {
                        ...
                        aold[Y*nx+X]=a[Y*nx+X];//store the old a tensor
                        
                        if (skip_flag==0) {//~~~~~~~~~
                            
                            //---begin: GE problem when AF,BF are symmetric and BF positive definite--
                            ...
                            if (_switch==0) {
                                ...
                                int count=0;
                                for (int x=1; x<=2*IF.indices()[0].m(); x++) {
                                    if (eigenvalues(x)<0) {
                                        count++;
                                    }
                                }
                            ...
                            if (endsweepflag==1) {
                                if (X==nx-1&&Y==ny-1&&xsweep==nxsweep) {
                                    if (_switch==0) {
                                        printf("Energy= %.10f\n",eigenvalues(min_index));
                                    }
                                    else if(_switch==1){
                                        printf("Energy= %.10f\n",1.0/eigenvalues(min_index));
                                    }
                        ...
                        ////////////////////////////////////////////////////////////////////////////////////////////////
                            ...
                            if (X>0) {
                                //PrintDat(a[Y*nx+X-1]);
                                a[Y*nx+X-1]=aold[Y*nx+X-1];
                                /////a[Y*nx+X-1].randomize();
                                //cout<<"randomize ("<<X-1<<", "<<Y<<") !!!"<<endl;
                                //cout<<"use old ("<<X-1<<", "<<Y<<") !!!"<<endl;
                                //PrintDat(a[Y*nx+X-1]);
                                areal[Y*nx+X-1]=realPart(a[Y*nx+X-1]);
                                aimag[Y*nx+X-1]=imagPart(a[Y*nx+X-1]);
                            }
                            else if(X==0&&Y>0){
                                //PrintDat(a[(Y-1)*nx+nx-1]);
                                a[(Y-1)*nx+nx-1]=aold[(Y-1)*nx+nx-1];
                                /////a[(Y-1)*nx+nx-1].randomize();
                                //cout<<"randomize ("<<nx-1<<", "<<Y-1<<") !!!"<<endl;
                                //cout<<"use old ("<<nx-1<<", "<<Y-1<<") !!!"<<endl;
                                //PrintDat(a[(Y-1)*nx+nx-1]);
                                areal[(Y-1)*nx+nx-1]=realPart(a[(Y-1)*nx+nx-1]);
                                aimag[(Y-1)*nx+nx-1]=imagPart(a[(Y-1)*nx+nx-1]);
                            }
                            else if(X==0&&Y==0  ){
                                //PrintDat(a[1]);
                                a[1]=aold[1];
                                /////a[1].randomize();
                                //cout<<"randomize ("<<1<<", "<<0<<") !!!"<<endl;
                                //cout<<"use old ("<<1<<", "<<0<<") !!!"<<endl;
                                //PrintDat(a[1]);
                                areal[1]=realPart(a[1]);
                                aimag[1]=imagPart(a[1]);
                            }
                        }
                        ////////////////////////////////////////////////////////////////////////////////////////////////
                        MPI_Barrier(communicator);
                    ...
                    //broadcasting the updated a tensor and find the corresponding IW and W tensors
                    if (skip_flag==0) {
...
//                        if (rank==1) {
//                            PrintDat(a[ytemp*nx+xtemp]);
//                            cout<<"broadcasting..."<<endl;
//                        }
                        
                        //broading the updated a to all processors
                        if (a[ytemp*nx+xtemp].r()==3) {
                            for (int i0=1; i0<=a[ytemp*nx+xtemp].indices()[0].m(); i0++) {
                                for (int i1=1; i1<=a[ytemp*nx+xtemp].indices()[1].m(); i1++) {
                                    for (int i2=1; i2<=a[ytemp*nx+xtemp].indices()[2].m(); i2++) {
                                        MPI_Bcast(&(areal[ytemp*nx+xtemp](areal[ytemp*nx+xtemp].indices()[0](i0),areal[ytemp*nx+xtemp].indices()[1](i1),areal[ytemp*nx+xtemp].indices()[2](i2))), 1, MPI_DOUBLE, 0, communicator);
                                        MPI_Bcast(&(aimag[ytemp*nx+xtemp](aimag[ytemp*nx+xtemp].indices()[0](i0),aimag[ytemp*nx+xtemp].indices()[1](i1),aimag[ytemp*nx+xtemp].indices()[2](i2))), 1, MPI_DOUBLE, 0, communicator);
                                    }
                                }
                            }
                        }
                        else if (a[ytemp*nx+xtemp].r()==4){
                            for (int i0=1; i0<=a[ytemp*nx+xtemp].indices()[0].m(); i0++) {
                                for (int i1=1; i1<=a[ytemp*nx+xtemp].indices()[1].m(); i1++) {
                                    for (int i2=1; i2<=a[ytemp*nx+xtemp].indices()[2].m(); i2++) {
                                        for (int i3=1; i3<=a[ytemp*nx+xtemp].indices()[3].m(); i3++) {
                                            MPI_Bcast(&(areal[ytemp*nx+xtemp](areal[ytemp*nx+xtemp].indices()[0](i0),areal[ytemp*nx+xtemp].indices()[1](i1),areal[ytemp*nx+xtemp].indices()[2](i2),areal[ytemp*nx+xtemp].indices()[3](i3))), 1, MPI_DOUBLE, 0, communicator);
                                            MPI_Bcast(&(aimag[ytemp*nx+xtemp](aimag[ytemp*nx+xtemp].indices()[0](i0),aimag[ytemp*nx+xtemp].indices()[1](i1),aimag[ytemp*nx+xtemp].indices()[2](i2),aimag[ytemp*nx+xtemp].indices()[3](i3))), 1, MPI_DOUBLE, 0, communicator);
                                        }
                                    }
                                }
                            }
                        }
                        else if (a[ytemp*nx+xtemp].r()==5){
                            for (int i0=1; i0<=a[ytemp*nx+xtemp].indices()[0].m(); i0++) {
                                for (int i1=1; i1<=a[ytemp*nx+xtemp].indices()[1].m(); i1++) {
                                    for (int i2=1; i2<=a[ytemp*nx+xtemp].indices()[2].m(); i2++) {
                                        for (int i3=1; i3<=a[ytemp*nx+xtemp].indices()[3].m(); i3++) {
                                            for (int i4=1; i4<=a[ytemp*nx+xtemp].indices()[4].m(); i4++) {
                                                MPI_Bcast(&(areal[ytemp*nx+xtemp](areal[ytemp*nx+xtemp].indices()[0](i0),areal[ytemp*nx+xtemp].indices()[1](i1),areal[ytemp*nx+xtemp].indices()[2](i2),areal[ytemp*nx+xtemp].indices()[3](i3),areal[ytemp*nx+xtemp].indices()[4](i4))), 1, MPI_DOUBLE, 0, communicator);
                                                MPI_Bcast(&(aimag[ytemp*nx+xtemp](aimag[ytemp*nx+xtemp].indices()[0](i0),aimag[ytemp*nx+xtemp].indices()[1](i1),aimag[ytemp*nx+xtemp].indices()[2](i2),aimag[ytemp*nx+xtemp].indices()[3](i3),aimag[ytemp*nx+xtemp].indices()[4](i4))), 1, MPI_DOUBLE, 0, communicator);
                                            }
                                        }
                                    }
                                }
                        ...
                        a[ytemp*nx+xtemp]=areal[ytemp*nx+xtemp]+Complex_i*aimag[ytemp*nx+xtemp];
                        
//                        if (rank==1) {
//                            PrintDat(a[ytemp*nx+xtemp]);
//                        }
                        
                        int ind=ytemp*nx+xtemp;
                        
                        if (rank==root) {
                            //                        cout<<"IW before updating at ("<<xtemp<<","<<ytemp<<")";
                            //                        Print(IW[ind]);
                            if (ytemp==0) {
                                if (xtemp==0) { //xtemp==0, ytemp==0
                                    IW[ind]=group_indice4((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1]);
                                }
                                else if (xtemp==nx-1){ //xtemp==nx-1, ytemp==0
                                    IW[ind]=group_indice4((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1]);
                                }
                                else { //0<xtemp<nx-1, ytemp==0
                                    //cout<<"409~~~~~~~~~~"<<endl;
                                    IW[ind]=group_indice6((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1], a[ind].indices()[3], primed(a[ind].indices()[3]), IW[ind].indices()[2]);
                                    //cout<<"411~~~~~~~~~~"<<endl;
                                }
                                ...
                                if (xtemp==0) { //xtemp==0, ytemp==ny-1
                                    IW[ind]=group_indice4((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1]);
                                }
                                else if (xtemp==nx-1){ //xtemp==nx-1, ytemp==ny-1
                                    //cout<<"419~~~~~~~"<<endl;
                                    IW[ind]=group_indice4((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1]);
                                    //cout<<"421~~~~~~~"<<endl;
                                }
                                else { //0<xtemp<nx-1, ytemp==ny-1
                                    //cout<<"422~~~~~~~~~~"<<endl;
                                    IW[ind]=group_indice6((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1], a[ind].indices()[3], primed(a[ind].indices()[3]), IW[ind].indices()[2]);
                                    //cout<<"424~~~~~~~~~~"<<endl;
                                }
                                ...
                                if (xtemp==0) { //xtemp==0, 0<ytemp<ny-1
                                    //cout<<"429~~~~~~~~~~"<<endl;
                                    IW[ind]=group_indice6((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1], a[ind].indices()[3], primed(a[ind].indices()[3]), IW[ind].indices()[2]);
                                    //cout<<"431~~~~~~~~~~"<<endl;
                                }
                                else if (xtemp==nx-1){ //xtemp==nx-1, 0<ytemp<ny-1
                                    //cout<<"434~~~~~~~~~~"<<endl;
                                    IW[ind]=group_indice6((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1], a[ind].indices()[3], primed(a[ind].indices()[3]), IW[ind].indices()[2]);
                                    //cout<<"436~~~~~~~~~~"<<endl;
                                }
                                else { //0<xtemp<nx-1, 0<ytemp<ny-1
                                    IW[ind]=group_indice8((Identity[ind]*a[ind]*dag(prime(a[ind]))), a[ind].indices()[1], primed(a[ind].indices()[1]), IW[ind].indices()[0], a[ind].indices()[2], primed(a[ind].indices()[2]), IW[ind].indices()[1], a[ind].indices()[3], primed(a[ind].indices()[3]), IW[ind].indices()[2], a[ind].indices()[4], primed(a[ind].indices()[4]), IW[ind].indices()[3]);
                                }
                            }
                            MPI_Barrier(communicator);
                    ...
                    if (rank==root) {
                        ...
                        ////////////////////////////////////////////////////////////////////////////////////////////////
                            ...
                            if (X<nx-1) {
                                ...
                                //PrintDat(a[(Y+1)*nx]);
                                a[(Y+1)*nx]=aold[(Y+1)*nx];
                                /////a[(Y+1)*nx].randomize();
                                //cout<<"randomize ("<<0<<", "<<Y+1<<") !!!"<<endl;
                                //cout<<"use old ("<<0<<", "<<Y+1<<") !!!"<<endl;
                                //PrintDat(a[(Y+1)*nx]);
                                areal[(Y+1)*nx]=realPart(a[(Y+1)*nx]);
                                aimag[(Y+1)*nx]=imagPart(a[(Y+1)*nx]);
                            }
                        }
                        ////////////////////////////////////////////////////////////////////////////////////////////////
                        MPI_Barrier(communicator);
