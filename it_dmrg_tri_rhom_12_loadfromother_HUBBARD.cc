...
main(int argc, char* argv[])
{
	...
	//IQMPO H = ExtendedHubbard(model,Opt("J",0.8)&Opt("t",-1.0));
    IQMPO H = ExtendedHubbard(model,Opt("U",10.0)& Opt("t1",-1.0)& Opt("t2",0.0)& Opt("V1",0)& Opt("Udif",0));
    //
    ...
    int Nsweeps=10;
	Sweeps sweeps(Nsweeps);
    sweeps.maxm() = 4000,4000,4000,4000,4000,4000,4000,4000,4000,4000;
