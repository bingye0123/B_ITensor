...
const extern int Monte_Carlo_nmeasure=800;
...
// 	cout<<C6_group_eigval_table<<endl;
	...
	//cout<<"From rank="<<rank<<" Monte Carlo sym eigval: "<<symmetry_sector_eigval_hubbard_MonteCarlo(desc,psi,C6_sym_mapping_table, translation_generator_mapping_table, COM_mom)<<endl;
