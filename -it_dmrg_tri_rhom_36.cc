...
main(int argc, char* argv[])
{
  MPI::Init(argc, argv); // initialize MPI environment
    ...
    //
    const IQMPO H = tJChain(model,Opt("J",0.6)&Opt("t",-1.0));
    ...
    ITiVec inv_sym_mapping_table="24 29 28 27 26 25 18 23 22 21 20 19 12 17 16 15 14 13 6 11 10 9 8 7 0 5 4 3 2 1 30 35 34 33 32 31";
	...
	ITiVec C6_sym_mapping_table_36_site="19 13 7 1 31 25 26 20 14 8 2 32 33 27 21 15 9 3 4 34 28 22 16 10 11 5 35 29 23 17 12 6 0 30 24 18";
