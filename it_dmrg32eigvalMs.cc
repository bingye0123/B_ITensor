...
// 	cout<<C6_group_eigval_table<<endl;
	...
	ITcVec COM_mom="-1. 1.";	
	std::string desc("UNSYM_M1");
	cout<<"From rank="<<rank<<" Monte Carlo sym eigval:"<<symmetry_norm_measurement_tj_MonteCarlo(desc,psi,translation_generator_mapping_table, COM_mom)<<endl;
	COM_mom(0)=1.;
	COM_mom(1)=-1.;	
	std::string desc2("UNSYM_M2");
	cout<<"From rank="<<rank<<" Monte Carlo sym eigval:"<<symmetry_norm_measurement_tj_MonteCarlo(desc2,psi,translation_generator_mapping_table,COM_mom)<<endl;
	COM_mom(0)=-1.;
	COM_mom(1)=-1.;	
	std::string desc3("UNSYM_M3");
	cout<<"From rank="<<rank<<" Monte Carlo sym eigval:"<<symmetry_norm_measurement_tj_MonteCarlo(desc3,psi,translation_generator_mapping_table,COM_mom)<<endl;
	...
	//cout<<"From rank="<<rank<<" Monte Carlo sym eigval: "<<symmetry_sector_eigval_hubbard_MonteCarlo(desc,psi,inv_sym_mapping_table, translation_generator_mapping_table, COM_mom)<<endl;

	//cout<<"From rank="<<rank<<" Monte Carlo sym eigval:"<<symmetry_norm_measurement_tj_MonteCarlo(desc,psi,translation_generator_mapping_table,COM_mom)<<endl;
	//cout<<"From rank="<<rank<<" Monte Carlo sym eigval: "<<symmetry_norm_measurement_hubbard_MonteCarlo(desc,psi,translation_generator_mapping_table,COM_mom)<<endl;
