...
const extern int Monte_Carlo_nmeasure=10000;
...
//	ITiVec C6_sym_mapping_table=C6_sym_mapping_table_32_site;
	...
	////cout<<"From rank="<<rank<<" Monte Carlo measure: "<<symmetry_sector_measurement_tj_MonteCarlo(desc,psi,transl_C6_generator_mapping_table,Ang_mom)<<endl;
	...
	//cout<<"From rank="<<rank<<" Monte Carlo sym eigval: "<<symmetry_eigval_hubbard_MonteCarlo(desc,psi,inv_sym_mapping_table)<<endl;
    /////cout<<"From rank="<<rank<<" Monte Carlo sym eigval: "<<symmetry_eigval_hubbard_MonteCarlo(desc,psi,T2_sym_mapping_table)<<endl;
	...
	cout<<"From rank="<<rank<<" Monte Carlo sym eigval: "<<symmetry_eigval_hubbard_MonteCarlo(desc,psi,C6_sym_mapping_table)<<endl;
