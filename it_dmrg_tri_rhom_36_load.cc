...
main(int argc, char* argv[])
{
    ...
    int Nsweeps=6;
	Sweeps sweeps(Nsweeps);
        //sweeps.maxm() = 4000,4000,4000,4000,4000,4000,4000,4000,4000,4000,4000,4000;//,4000,4000,4000,4000,4000,4000,4000,4000,6000,6000,6000,6000,6000,10000,10000,10000,10000,10000;
        sweeps.maxm() = 10000,10000,10000,10000,10000,10000;//,8000;//,6000,6000,6000,6000;
