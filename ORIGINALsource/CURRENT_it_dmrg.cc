...
const extern int Monte_Carlo_nmeasure=80000;
//number of steps between measurement
const extern int Monte_Carlo_n_between_measure=10;
...
main(int argc, char* argv[])
{
  MPI::Init(argc, argv); // initialize MPI environment
    ...
    //const IQMPO H = ExtendedHubbard(model,Opt("U",0.01)& Opt("t1",1)& Opt("t2",0.0)& Opt("V1",0));
...
//     cout << sweeps;
        ...
        int Nsweeps=8;
	Sweeps sweeps(Nsweeps);
	sweeps.maxm() = 10,20,20,20,20,20,20,20,20,20,50,50,50,50,50,50,50,50,50,50,100,100,100,100,100,100,100,100,100,100,200,200,200,200,200,200,200,200,200,200;
	sweeps.cutoff() = 1E-10,1E-10,0.;
	sweeps.niter() = 2;
...
//       cout<<"Writing done."<<endl;
	...
	cout<<"From rank="<<rank<<" Monte Carlo measure: "<<symmetry_sector_measurement_tj_MonteCarlo(psi,transl_C6_generator_mapping_table,COM_Ang_mom)<<endl;
