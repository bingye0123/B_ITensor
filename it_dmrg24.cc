...
//	ITiVec C6_sym_mapping_table=C6_sym_mapping_table_32_site;
	...
	std::string descsectoreig("G_c6_10000");
	...
	cout<<"From rank="<<rank<<" Monte Carlo measure: "<<symmetry_sector_eigval_tj_MonteCarlo(descsectoreig,psi, C6_sym_mapping_table, translation_generator_mapping_table, COM_mom)<<endl;
