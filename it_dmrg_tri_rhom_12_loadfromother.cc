...
main(int argc, char* argv[])
{
	...
	IQMPO H = tJChain(model,Opt("J",0.8)&Opt("t",-1.0));
    //
    ...
    int Nsweeps=5;
	Sweeps sweeps(Nsweeps);
    sweeps.maxm() = 6000,6000,6000,6000,6000;//,6000,4000,4000,4000,4000,4000,4000,4000,4000,4000,4000,4000,4000,4000,4000;
