...
//// A*x = lambda*B*x
void inline
dggev_wrapper(char* jobvl,           //if 'V', compute both eigs and evecs
              //if 'N', only eigenvalues
              char* jobvr,           //if 'U', use upper triangle of A
              LAPACK_INT* n,        //number of cols of A
              LAPACK_REAL* A,       //matrix A, on return contains eigenvectors
              LAPACK_REAL* B,       //matrix B
              ...
              LAPACK_INT* info)  //error info
{
    ...
    dggev_(jobvl,jobvr,n,A,n,B,n,alphar,alphai,beta,v,n,v,n,work,&lwork,info);
