...
*/
	...
	ITcVec Ang_mom8(1);
	Ang_mom8(0)=std::exp(Complex_i*2.*Pi/3.);
	//Ang_mom8(0)=1.;
...
//	ITiVec C6_sym_mapping_table=C6_sym_mapping_table_8_site;
	...
	ITiVecArray rotation_generator_mapping_table(1);
	rotation_generator_mapping_table(0)=C6_sym_mapping_table;
	ITcVec Ang_mom(1);
	...
	std::string desc("G_p2P3");
	std::stringstream ffim;
	ffim << "/home/mesaros/resitdmrg/hltj_32_J_1.0_07/NormG_G1_400/statesSYM1_32J1G_G1Norm_500_400x40rank"<<rank<<".txt";
	...
	// cout<<"From rank="<<rank<<" Monte Carlo measure: "<<symmetry2_norm_measurement_fromfiles_tj_MonteCarlo(inputstates,desc,Nmeasure,psi,translation_generator_mapping_table,COM_mom,transl_C6_generator_mapping_table,COM_Ang_mom)<<endl;
	cout<<"From rank="<<rank<<" Monte Carlo measure: "<<symmetry2_norm_measurement_fromfiles_tj_MonteCarlo(inputstates,desc,Nmeasure,psi,translation_generator_mapping_table,COM_mom,rotation_generator_mapping_table,Ang_mom)<<endl;
	//cout<<"From rank="<<rank<<" Monte Carlo measure: "<<symmetry2_norm_measurement_fromfiles_hubbard_MonteCarlo(inputstates,desc,Nmeasure,psi,translation_generator_mapping_table,COM_mom,transl_C6_generator_mapping_table,COM_Ang_mom)<<endl;

	//cout<<"From rank="<<rank<<" Monte Carlo measure: "<<symmetry2_norm_measurement_tj_MonteCarlo(desc,psi,translation_generator_mapping_table,COM_mom,transl_C6_generator_mapping_table,COM_Ang_mom)<<endl;
	//cout<<"From rank="<<rank<<" Monte Carlo measure: "<<symmetry2_norm_measurement_hubbard_MonteCarlo(desc,psi,transl_C6_generator_mapping_table,COM_Ang_mom)<<endl;
