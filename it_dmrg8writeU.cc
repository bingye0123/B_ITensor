...
const extern int Monte_Carlo_nmeasure=2000;
//number of steps between measurement
const extern int Monte_Carlo_n_between_measure=50;
...
main(int argc, char* argv[])
{
  MPI::Init(argc, argv); // initialize MPI environment
    ...
    const IQMPO H = ExtendedHubbard(model,Opt("U",3)& Opt("t1",1)& Opt("t2",0.0)& Opt("V1",0));
